...
color:"#fdf8f0", fontSize:28, margin:"0 0 8px",
}}>Our Scrapbook</h2>
<p style={{
fontFamily:"'Caveat',cursive", fontSize:18,
color:"#e8d5b0", marginBottom:28, lineHeight:1.5,
...
border:"none", borderBottom:"2px solid #d4a017",
background:"transparent", textAlign:"center",
outline:"none", color:"#fdf8f0", padding:"8px 0",
width:220, display:"block", margin:"0 auto 12px",
}}
/>
{pwError && (
<div style={{
fontFamily:"'Caveat',cursive",
color:"#ff6b6b", fontSize:16, marginBottom:12,
}}>Wrong password, try again 🙈</div>
)}
<button onClick={tryUnlock} style={{
background:"linear-gradient(135deg,#d4a017,#f5c842)",
color:"#3d2b1f", border:"none",
borderRadius:30, padding:"12px 40px",
fontFamily:"'Playfair Display',Georgia,serif",
fontSize:17, fontWeight:700, cursor:"pointer",
marginTop:8, boxShadow:"0 4px 16px rgba(212,160,23,.4)",
}}>Enter 💌</button>
</div>
<style>{`@import url('https://fonts.googleapis.com/css2?family=Caveat:wght@400;700&family=Playfair+Display:wght@400;700&display=swap');`}</style>
</div>
);
}
...
On Sat, 18 Apr 2026 at 15:35, Gathoni Muhindi <sonimuhindi@gmail.com> wrote:
import { useState, useRef, useCallback, useEffect } from "react";
import { initializeApp } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-app.js";
import {
getFirestore, collection, doc, addDoc, deleteDoc,
